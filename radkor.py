...
print (Fore.YELLOW + "")
time.sleep(1.7)
print ("                       RUBIKA ID - @HADI_RADKOR IM RADKOR")
print("                      RUBIKA= On -- @Radkor")
print ("                telegram @Kali_Linux_NULL")
print ("insta @hadi_radkor")
print(f"{blue} ")
time.sleep(1.0)
print ("!!")
time.sleep(0.7)
...
|||||Telegram: https://t.me/Kali_Linux_NULL ||||
|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|
____________ id:NULL_radkor___________
""")
print(f"{red} ")
...
print(f"{green}" )
print ("""Radkor""")
print (" group tel=>> https://t.me/Kali_Linux_NULL")
print(f"{blue}" )
print(" ")
print("love hack")
print("")
...
print("")
print(" Chanel Telegram=>> @Kali_Linux_NULL -")
print (Fore.WHITE + " ")
time.sleep(3.0)
print (" Hadi Radkor")
time.sleep(3.0)
